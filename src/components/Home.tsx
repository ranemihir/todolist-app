                    ...
                    <div className="container-fluid">
                        ...
                        <div className="d-flex flex-row align-items-center float-end">
                            ...
                            <div className="d-flex flex-column">
                                ...
                                <a className="text-muted text-decoration-none" href='/api/auth/google/logout'><small>Sign Out</small></a>
                            </div>
                        </div>
                    </div>
                }
            ...
            <div className="container">
                <div className="row justify-content-center pt-5">
                    <div className="d-flex mt-5 mx-3">
                        ...
                        <button className="btn btn-outline-primary" style={{ fontWeight: 500, letterSpacing: 1 }} onClick={handleClick}>
                            Add
                        </button>
                    </div>
                </div>
